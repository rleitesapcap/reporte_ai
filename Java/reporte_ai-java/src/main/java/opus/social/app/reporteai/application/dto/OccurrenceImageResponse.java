...
public class OccurrenceImageResponse {
    private UUID id;
    ...
    public OccurrenceImageResponse() {}

    public OccurrenceImageResponse(UUID id, UUID occurrenceId, String s3Url, String s3Key,
            Integer imageSize, String imageFormat, LocalDateTime uploadedAt, Boolean processed) {
        this.id = id;
