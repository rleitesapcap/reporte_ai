...
@Component
public class OccurrenceNotFoundHandlerStrategy implements ExceptionHandlerStrategy<EmployeeNotFoundException> {

    @Override
    public ResponseEntity<Object> handle(EmployeeNotFoundException exception) {
        Map<String, Object> errorResponse = new HashMap<>();
        errorResponse.put("status", HttpStatus.NOT_FOUND.value());
        errorResponse.put("error", "Occurrence Not Found");
    ...
    public String getHandlerName() {
        return "OccurrenceNotFoundHandler";
    }
}
